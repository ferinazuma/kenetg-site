...
function bindActionButtons() {
    document.addEventListener("click", (event) => {
        ...
        const actionTarget = target === null || target === void 0 ? void 0 : target.closest("[data-action]");
        if (!actionTarget)
            return;
...
function scrollToStore() {
    ...
    store === null || store === void 0 ? void 0 : store.scrollIntoView({ behavior: "smooth", block: "start" });
}
...
function setupGeoBanner(geoApi, geoOptions) {
    ...
    function saveDeclined() {
        ...
        (_a = geoApi._save) === null || _a === void 0 ? void 0 : _a.call(geoApi, payload);
        if (geoApi._save)
            return payload;
        try {
            const key = (geoApi.config && geoApi.config.storageKey) ||
