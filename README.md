...
- Minificado: usa `node dev/scripts/minify.js` para generar `web/assets/js/*.min.js`, `web/assets/css/styles.min.css` y HTML comprimido en `web/dist/`. Las paginas ya referencian las versiones `.min` de JS y CSS.
